...
mysqli_query($conn,"UPDATE subjects SET scode='$scode',sname='$sname',ssem='$ssem',scredit='$scredit' WHERE sid = '$id' ");
//mysqli_query($conn,"update register set name='$name' where reg_no = 2001;");
echo "succesfully updated asijflskjfdjfjdfjfjidjfoiejuroiueio".$id; 
...
<div style="color:black ;border-radius: 20px; padding: 70px 0px 70px 70px;background-color:white;opacity: 0.8; ">
  ...
  <tr>
  <td >
  <input class="tbox" type="text" name="ucode" value="<?php echo $scode; ?>"  >
    </td>
  <td>
      <input class="tbox" type="text" name="sname" value="<?php echo $sname; ?>"  required>
    </td>
  </tr>
  <tr>
  <td ><h3><b>Semester</b></h3></td>
  <td ><h3><b>Credit</b></h3></td>
  </tr>
  <tr>
  <td > <select class="tbox" name="ssem" value="1" width="200px" value="<?php echo $ssem; ?>" required >
    ...
    <td >  <input class="tbox" type="text" name="scredit"  value="<?php echo $scredit; ?>" required></td>

  </tr>
  
  
  <tr>   <td >  <input class="tbox" style="display:none" type="text" name="id1"  value="<?php echo $id; ?>" >
      <input class="button button2" type="submit" value="submit" name="submit"></td></button></td>
