...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b> UNIT -I: (04 Lecture)
Overview of Software Project Planning
Software Project, Categorization of software Project, Introduction to Stepwise Project
Planning,
UNIT- II: (04 Lecture)
Project Evaluation
...
forecasting, Risk
Unit III: (08 Lecture)
Software Effort Estimation & Activity Play Over & under estimation problem, basis for
software
estimation, Estimation by analogy, COCOMO, Parameter Model function, point analysis,
Project
schedule, Planning Model, Project Time management, Activity duration estimation.
Unit IV : (04 Lecture)
Risk management, Identification, Analysis and abatement of risk, Nature of resources,
critical,
county cost, schedule, Monetary & control, Cost Monitoring, Priority by monetary,
Managing</b>
 </p><br><br>
...
<br>
    ...
    <ol>
   <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Software Project Management, A Unified Framework "WALKER ROYCE"
"First Edition" "Peason Education".</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Software Project Management, 6th Edition (TMH)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quality Software Project Management by Robert T. Futrel, Pearson
Education. </li>
</ol>   
</b>
 </p><br><br>
