...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>In this course students will study the fundamental principles of object-oriented
approaches to modeling software requirements and design. Topics include strategies for
identifying objects and classes of objects, specification of software requirements and
design, the design of class hierarchies, software reuse considerations, graphical notations,
system implementation using object-oriented and object-based programming languages,
and comparison of object-oriented approaches to more traditional approaches based on
functional decomposition.</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
        <ol >
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Introduction, Need for formal and semi-formal modeling, UML-2 Meta-model
(4)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UML-2 Concepts and Examples: Object, Class, Relationship, Interface, Types,
roles, Use Case, Interaction and Activity Diagrams, State Machine and State-chart
Diagram, Events, signals, Process and threads (8)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Software System Design, Design Patterns, Pattern Classification, Creational,
Structural and Behavioral patterns, Idoms (12)  </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agents and Agent Modeling, Multi-Agent Systems Modeling, Case Study (6) </li>
