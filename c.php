...
<div style="padding-center:0px; padding-left:50px; color: MidnightBlue; font-size: 20px; text-shadow: -1px 0 black, 0 1px OrangeRed, 1px 0 gold, 0 -1px red;">
  <h2>Problem And Programming Solving </h2>
  </div></div>
<br><br>
<div class="row">
  <div class="side">
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>This is a first course in programming which intends to introduce students to the
...
programming in Unix/Linux environment. This course has a associated lab with it.</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
        <ol >
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Introduction, LINUX Commands, editors, Files & Directories, Design of algorithms (4)  </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Writing a Simple Program: Learning the form of a C program, Declaring variables, designing program flow and control, using standard terminal I/O &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;functions. (6)  </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fundamental Data Types and Storage Classes, Operators and Expressions Conditional Program Execution Loops and Iteration, Introduction to &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Abstraction, functions, (8)  </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arrays, Pointers, Structures (7)  </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Introduction to Object Oriented Programming concepts, Classes and Objects, Important C++ constructs, Brief introduction to few other object oriented &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;languages (10)  </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Standard C/C++ Preprocessor, The Standard C/C++ Library (5)  </li>
        </ol>    
</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
    <ol>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;How to solve it by Computer by R. J. Dromey </li>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The C Programming Language by Brian W. Kernighan, Dennis M. Ritchie </li>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;On to C++ by P H Winston ( also available online) </li>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Structure and Interpretation of Computer Programs by Harold Abelson and
     Gerald Sussman with Julie Sussman, (Also available online)</li>
