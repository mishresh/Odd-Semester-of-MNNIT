...
<div class="topnav">
  ...
  <a class="active" href="sem.php">Home</a>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="gaurav.jpg" alt="Jane" style="width:100%">
      <div class="container">
        <h2>Gaurav Mishra</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="rohit.jpeg" alt="Mike" style="width:100%">
      <div class="container">
        <h2>Rohit Ranjan</h2>
        <p class="title">Backend</p>
        <p>ranjan@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  <div class="column">
    <div class="card">
      <img src="sarvesh.jpeg" alt="John" style="width:240px;height:240px;">
      <div class="container">
        <h2>Sarvesh Rawat</h2>
        <p class="title">frontend</p>
        <p>sarveshrawat@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
...
<div class="row" style="margin-left:100px;">
  <div class="column">
    <div class="card" >
      <img src="shraddha.jpg" alt="Jane" style="width:200px;height:200px;">
      <div class="container">
        <h2>Shraddha</h2>
        <p class="title">Frontend</p>
  ...
  <div class="column" style="margin-left:100px;">
    <div class="card">
      <img src="sujata.jpeg" alt="Jane" style="width:200px;height:200px;">
      <div class="container">
        <h2>Sujata Singh</h2>
        <p class="title">Frontend</p>
        <p>sujata@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
