...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>This course offers a presentation of fundamental tools required in advanced computer
science. The main topics covered in this subject include propositional and first-order
logic, recursion, proofs, other kinds of logic. This forms the basis for the subjects like
Automata theory and formal methods.</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
        <ol >
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Introduction, Set theory, Notion of proofs , Linear congruence (4)</li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formal logic: Propositional Logic, Relational logic, First order logic, and related
issues (8) </li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lattices and related issues (8)</li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Group Theory and related issues, Finite Fields and related issues (6)</li>
            <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Generating Functions and related issues (4)</li>
        </ol>    
</b>
 </p><br><br>
