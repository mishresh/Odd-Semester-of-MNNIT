...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>In this course students will study the basic facilities provided in modern operating
systems. The emphasis will be on understanding general concepts that are applicable to a
wide range of operating systems, rather than a discussion of the features of any one
specific system. Topics that will be covered in the course include: protected kernels,
processes and threads, concurrency and synchronization, memory management, virtual
memory, file systems, secondary storage, protection, and security. This course requires as
prerequisite the course on computer programming, data structures and computer
organization. This course has an associated lab with it.</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
        <ol >
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Introduction and Overview (2) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Process fundamentals, scheduling, synchronization (12)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Inter-process communication, Deadlock (8)  </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Memory management and virtual memory (7) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File system and secondary storage (5)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Protection and security issues, Case studies e.g. Linux, Solaris and Android (6)</li>
...
<br>
    ...
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Operating Systems, by William Stallings </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Operating Systems Concepts by Silberschatz, Galvin, and Gagne </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Design of the UNIX Operating System, by Maurice J. Bach  </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advanced Programming in the UNIX Environment, by W. R. Stevens & S. A. Rago </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Design and implementation of the 4.4 BSD UNIX operating system by Marshall Kirk McKusick, Keith Bostic, Michael J. Karels, John S. Quarterman</li></ol>   
</b>
 </p><br><br>
