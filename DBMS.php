...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>In this course students will study the basic functions and capabilities of database
management systems (DBMS). Emphasis is placed on the use of DBMS in solving
information processing problems which will include database design case studies as well
as SQL programming assignments along with transactions. A lab course is associated
with it to strengthen the concepts.</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
        <ol >
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database system concept and architecture, Entity Relationship and Enhanced E-R (5)</li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Relational Data Model and Relational Algebra, SQL, Indexing, Query Optimization (10) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Relational Database Design, Normalization principles and normal forms (8) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transaction concept and concurrency control (8) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web Interface to DBMS, Semi-structured databases, Object oriented databases (6) </li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DBMS Case studies (3) </li>
        </ol>    
</b>
 </p><br><br>
...
<br>
      <p div style="padding: 10px 20px 10px 20px;"><b>
    <ol>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database system concepts, by Korth, Silberschatz, and Sudarshan</li>
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fundamentals of Database Systems by Elmasari and Nawathe</li>
     <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Databases by O Neil</li>
     <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database Systems The Complete Book by Garcia-Molina, Ullman, & Widom</li>
     <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database Management System by Ramakrishnan and Gehrke</li>
    </b>
 </p><br><br>
