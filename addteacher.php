...
$teacher_code = mysqli_real_escape_string($conn, $_POST['teacher_code']);
  $teacher_name = mysqli_real_escape_string($conn, $_POST['teacher_name']);
   $tdescription = mysqli_real_escape_string($conn, $_POST['tdescription']); 
  $tsubject = mysqli_real_escape_string($conn, $_POST['tsubject']);
  $tmobile = mysqli_real_escape_string($conn, $_POST['tmobile']);
   $temail = mysqli_real_escape_string($conn, $_POST['temail']); 
  $tsem = mysqli_real_escape_string($conn, $_POST['tsem']);
    $query = "INSERT INTO teachers (tid, tname, tsubject, tsem, description, temail, tmobile) VALUES ('$teacher_code', '$teacher_name',  '$tsubject', '$tsem','$tdescription' , '$temail','$tmobile')";
...
<!-- new edition
  ...
  <tr>
  <td ><h3><b>Teacher Code</b></h2></td>
  <td ><h3><b>Teacher Name</b></h3></td>
  <tr>
  <td >
  <input class="tbox" type="text" name="teacher_code"  required>
  </td>
  <td>
      <input class="tbox" type="text" name="teacher_name"  required>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td >  <input class="tbox" type="text" name="tdescription"   required></td>
    <td >  <input class="tbox" type="text" name="tsubject"   required></td>
  ...
  <tr>
    <td > <select name="tsem" class="tbox" value="1" width="200px"  required >
    ...
    <td >  <input class="tbox" type="text" name="tmobile"   required></td>
   </tr>
   <tr>
    <td ><h3><b>Email</b></h3></td>
    </tr>
    <tr>
    <td >  <input class="tbox" type="email" name="temail"   required></td>  
  
    <td > <input button class="button button2" type="submit" value="submit" name="add_teacher"></td></button></td>
