...
$scode = mysqli_real_escape_string($conn, $_POST['subject_code']);
  $sname = mysqli_real_escape_string($conn, $_POST['subject_name']);
  ...
  $scredit = mysqli_real_escape_string($conn, $_POST['scredit']);
   ...
   // $query = "insert into subjects (scode,sname,ssem,scredit) values ('455','ofoskf',2,4)";
...
<div style="padding-center:0px; padding-left:50px; color: MidnightBlue; font-size: 20px; text-shadow: -1px 0 black, 0 1px OrangeRed, 1px 0 gold, 0 -1px red;">
  ...
  <tr>
  <td > <select name="ssem" class="tbox" value="1" width="200px"  required >
    ...
    <td >  <input class="tbox" type="text" name="scredit"   required></td>
...
<center>
 <input button class="button button2" type="submit" value="submit" name="add_subject"><div>
 </center>
